...
const DEFAULTS = {
  ...
  stopRms: 0.010,      // これを下回り続けたら「話し終わった」。⚠️ 高いと小さい声が無音扱いで切られる
  startFrames: 2,      // 単発の物音で始めない
  silenceMs: 1500,     // 話し終わりと決めるまでの静けさ。⚠️ 0.85 秒だと息継ぎで切られた（実測）
  noSpeechMs: 25000,   // 何も話さないまま待つ上限。⚠️ 9 秒だと考えている間に切られる（実測）
